...
const Heading = () => (
  <>
    <h1 className="heading">Find your email</h1>
    <h4 className="sub-heading">Enter your phone number or recovery email</h4>
  </>
);
...
const Input = () => (
  <div className="email-form">
    <form>
      ...
      <span className="input-placeholder">Phone number or email</span>
    </form>
  </div>
);
