...
export default function SignUp({value, setValue, errors, handleSubmit, register, watch, onSubmit}) {
  return (
    <>
      <Helmet>
      ...
      <section className="flex-container">
        ...
        <section className="signpage-container">
          <main className="form-container">
            <Logo />
            <Heading />
            <Form value={value} setValue={setValue} onSubmit={onSubmit} watch={watch} register={register} handleSubmit={handleSubmit} errors={errors}/>
          </main>
          <AccountLogo />
        </section>
        <SignPageFooter />
